...
class LSR(nn.Module):
    ...
    def forward(self, context_idxs, pos, context_ner, h_mapping, t_mapping,
        ...
        #e_i, e_j representation computing 
        ...
        re_rep = self.self_att(re_rep, re_rep, relation_mask) #why are the computing self_attn?
        return self.linear_output(re_rep) #sigmoid 
